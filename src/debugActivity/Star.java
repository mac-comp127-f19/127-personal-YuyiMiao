...
public class Star extends GraphicsGroup {
    public void draw() {
        ...
        List<Point> newPoints = translateStarPoints(starPoints, new Point(100, 100));

        Path poly = new Path(newPoints);
        poly.setFillColor(Color.YELLOW);
        add(poly);
    }

    private List<Point> translateStarPoints(List<Point> points, Point delta) {
